...
performance in pH measurement</title>
	...
	<meta property="og:image" content="{{ config('app.url') }}images/tf-banner-ross-electrodes-og.jpg">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 PF-PL0 PF-PR0">
				<img src="{{ config('app.url') }}images/tf-banner-ross-electrodes.jpg" alt="thermofischer" title="How electrode design correlates with optimum
...
the process and ensure a quality product.</p>
			...
			<div class="col-md-4 col-xs-12 PF-PTB10" style="margin-top: 2rem">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-bg PF-P20"> 
						...
						<form action="{{route('transferStrategies.post')}}" method="post">
							@csrf
	...
	<div class="container" style="margin-top: 2rem">
		<div class="row">
			<div class="col-sm-6 mx-auto">
				<img style="width: 100%" src="{{ config('app.url') }}images/tf-ross-electrode-2.jpg" alt="thermofischer" title="ross-electrode-1" class="img-responsive" />
			</div>
			<div class="col-sm-6 mx-auto">
				<img style="width: 100%" src="{{ config('app.url') }}images/tf-ross-electrode-1.jpg" alt="thermofischer" title="ross-electrode-2" class="img-responsive" />
			</div>
		</div>
	</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-primary" role="button" id="aa" name="aa"  href="{{url('promotion/transfer-strategies-for-pharmaceutical-product')}}" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
