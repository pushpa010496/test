...
<head>
	...
	<title>Is Pharma Ready To Embrace Virtual Trials</title>
	<meta name="viewport" content="width=device-width" />
	<meta name="robots" content="noindex" />
	<link rel="shortcut icon" href="{{ config('app.url') }}images/favicon.ico" type="image/x-icon">
	<meta name="title" content="Is Pharma Ready To Embrace Virtual Trials" />
	<meta name="description" content="Is Pharma Ready To Embrace Virtual Trials" />
	<meta name="keywords" content="" />
	<meta property="og:title" content="Is Pharma Ready To Embrace Virtual Trials" />
	<meta property="og:description" content="Is Pharma Ready To Embrace Virtual Trials" />
	<meta property="og:Keywords" content=""/>
	<meta property="og:image" content="{{ config('app.url') }}images/oracle-health-sciences-embrance-og.jpg" />
...
<!-- 
				 <div class="col-md-3 col-6 offset-md-6 align-self-center" align="right">
					<img src="{{ config('app.url') }}images/oracle-health-sciences-logo.jpg" alt="Pharma Focus Asia" class="img-fluid pt-1 pb-1" width="220">
				</div> --> 
			</div>
		</div>
	</div>
	...
	<div class="container-fluid shadow">	
		<div class="row">
			<img src="{{ config('app.url') }}images/oracle-health-sciences-virtual-banner.jpg" alt="Oracle - AI Revolution in Multivigilance" class="img-fluid">
		</div>		
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-12">		
				...
				<p class="pt-4">Using a virtual, or decentralized, approach to clinical trials has the
					potential to improve patient experience and data quality while
					also accelerating the time it takes to get new drugs on the market.
					Although these benefits have been apparent for years, the COVID-19
					pandemic created an urgent need to implement virtual approaches.</p>

				<p>This quick transition demonstrated that these patient-centric
					models can work even on large scales. It also helped those involved
					in clinical trials feel more comfortable and confident in virtual
					approaches that will likely be the new normal moving forward.</p>

				<p>As clinical trials incorporate more virtual components, study teams
and sites need more patient information, clinical insight, and control
with less system complexity and burden. Oracle Health Sciences
developed the Clinical One advanced eClinical platform to support
all types of trials in the simplest, most user-friendly way, providing a
way to collect and manage all the clinical data in one place.</p>
			...
			<div class="col-lg-4 col-12 pt-3 pb-4">
				...
				<div class="form-bg p-3"> 
					...
					<form action="{{route('oracleEmbraceVirtualTrials.post')}}" method="post">
	               		{{csrf_field()}}
	               		<input type="hidden" name ="g-recaptcha-response" id ="g-recaptcha-response">
	               		<input type="hidden" name="formtype" value="normal-form">
	               		<input type="hidden" name="type" value="Oracle HS (embrace virtual trials)">	
	                  	...
	                  	<div class="form-group">
	                  		<select class="form-control" name="pdf_language" required>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">				
					<a class="btn btn-seconadry" role="button" id="aa" name="aa"  href="{{url('promotion/oracle-embrace-virtual-trials')}}" aria-expanded="false">
						Close
					</a>					
				</div>
			</div>
