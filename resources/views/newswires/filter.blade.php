        ...
        <div class="row PF-MobP030">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active PF-TXTRED text-capitalize" aria-current="page">Pharma Pressreleases</li>
            </ol>
          </nav>
        </div>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-12 PF-BrdrDDD p-1">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 pb-2">
                <div class="PF-BrdrBEEE col-lg-12 col-md-12 col-sm-12 col-12 p-0 mb-3">
                  <h1 class="PF-Bshelf pt-2">Pharma Pressreleases</h1>            
                </div>
                <p>This section covers the managerial aspects in the Pharma industry.</p>
              </div>
