        ...
        <div class="row PF-MobP030">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active PF-TXTRED" aria-current="page">{{trans('messages.technotrends_title')}}</li>
            </ol>
          </nav>
        </div>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-12 PF-BrdrDDD p-1">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 pb-2">
                <div class="PF-BrdrBEEE col-lg-12 col-md-12 col-sm-12 col-12 p-0 mb-3">
                  <h1 class="PF-Bshelf pt-2">{{trans('messages.technotrends_title')}}</h1>            
                </div>
                <p>{{trans('messages.technotrends_text')}}</p>
              </div>            
              @foreach($technotrends as $val)
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 title-list">
                <h2 class="mb-1 PF-TXTBlk000">
                  <a href="{{ route('technotrends.url',[$val->url])}}" title="{{$val->title_tag}}" class="PF-TXTBlk000">{!! $val->title!!}</a>
                </h2>
