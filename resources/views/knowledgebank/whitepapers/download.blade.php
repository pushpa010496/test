			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					<li class="breadcrumb-item">
						<a href="{{url('/knowledgebank')}}">Knowledge Bank
						</a>
					</li>
					<li class="breadcrumb-item">
						Whitepaper Form
			        	...
			        	<form action="{{ route('whitepapersform.post',[$whitepaper->url])}}" class="email" id="writemessage" method="post" accept-charset="utf-8">
			        		...
			        		<div class="row">
			        			<div class="form-group col-lg-6 {{ $errors->first('fullname', 'has-error')}}">
			        				...
			        				<input type="hidden" value="{{$whitepaper->id}}" name="whitepaper_id" id="type">
			        				<input type="hidden" value="{{$whitepaper->title}}" name="title">
