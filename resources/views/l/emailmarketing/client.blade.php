...
<table width="800" border="0" align="left" cellpadding="10">
  ...
  <tr>
    ...
    <td>
      ...
      <tr>
        <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px;">Thank you for downloading our Pharma focus asia Media Pack.</td>
      </tr>
      <tr>
        <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px;">Our Media Pack helps to discover more about Pharma focus asia services & rate cards that can help your business reach healthcare audiences. Pharma focus asia media pack includes information on our visitor's attraction/advertising services with pricing structure.</td>
      </tr>
       <tr>
        <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px;">Information regarding the size and cost of adverts in our magazine can also be found on our rate card.</td>
      </tr>
       <tr>
        <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px;">Get an inside look at how to connect with our pharma professionals worldwide. Great advertising rates available!</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
