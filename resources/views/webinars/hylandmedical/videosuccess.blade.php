...
<head>
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/hyland/hyland-webinar-ondemand-og.jpg" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="{{config('app.url')}}webinars/hyland/hyland-ondemand.mp4" type="video/mp4">
            </video>
          <!-- <video loop autoplay controls="true" width="100%" height="100%" src="{{config('app.url')}}webinars/hyland/20210205_170318.m4v" type="video/m4v"></video>   -->
      </div>
    </div> 
  </div>
</div>
