...
<head>
	...
	<title>Advantech Telehealth - iHealthcare Online Conference</title>

	<!-- Meta Tags -->
	<meta property="og:title" content="Advantech Telehealth - iHealthcare Online Conference" />
	...
	<meta property="og:image" content="{{config('app.url')}}/webinars/advantech-telehealth/advantech-og.jpg" />
	<link rel="canonical" href="{{url('advantech-healthcare-on-demand-telehealth-today')}}"/>
	...
	<meta property="og:url" content="{{url('suez-toc-webinar')}}" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="{{config('app.url')}}webinars/advantech-telehealth/telehealth-today-turning-opportunities.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
