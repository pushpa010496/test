...
<head>
	...
	<title>Integrated Digital Healthcare | Alcatel-Lucent Enterprise</title>

	<link rel="shortcut icon" href="{{ config('app.url') }}/images/favicon.ico" type="image/x-icon">

	<!-- Meta Tags -->
	<meta property="og:title" content="Integrated Digital Healthcare | Alcatel-Lucent Enterprise" />
	...
	<meta property="og:image" content="{{config('app.url')}}webinars/integrated-digital-healthcare/idh-ondemand-banner.jpg" />
	<link rel="canonical" href="{{url('integrated-digital-healthcare-webinar')}}"/>
	...
	<meta property="og:url" content="{{url('integrated-digital-healthcare-webinar')}}" />
    ...
    <div class="container">
      ...
      <div class="col-md-8 offset-md-2 mt-4">
          <video width="100%" controls autoplay>
              <source src="{{config('app.url')}}webinars/integrated-digital-healthcare/alcatel-on-demand.mp4" type="video/mp4">
            </video>
      </div>
    </div> 
  </div>
