        ...
        <div class="row PF-MobP030">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">
               {{trans('messages.authorguidelines-download_title')}}          
           	  </li>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 PF-BrdrDDD p-1">
	            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pb-2">
	                <div class="PF-BrdrBEEE col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0 mb-1">
	                  <h1 class="PF-Bshelf pt-2">{{trans('messages.authorguidelines-download_title')}}</h1>            
	                </div>
	            </div>
            	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  	<p>{{trans('messages.authorguidelines-download_text')}}</p>
              	</div>
	            ...
	            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			        ...
			        <div class="text-center pb-3 pt-2">
		          	...
		          	<div class="form-area col-lg-12 col-md-12 col-sm-12 mt-2">  
		            	<form action="{{url('/authorguidelines-download')}}" class="email" id="writemessage" method="post" accept-charset="utf-8">
		       				{{ csrf_field() }}
			              	<h2 class="mb-3">Please fill the below form to download our <span class="PF-Caps PF-TXTRED">Editorial Author Guidelines</span></h2>
			              	...
			              	<div class="row">
				                <div class="form-group col-lg-6 {{ $errors->first('fullname', 'has-error')}}">
				                	...
				                	<input type="hidden" value="authorguidelines-download" name="type" id="type">
