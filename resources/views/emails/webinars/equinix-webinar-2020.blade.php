            ...
            <td>
              <table width="1000" border="0" cellpadding="5">
                  <tr>
                    ...
                    <td width="20">&nbsp;</td>
                    <td width="1000" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:15px;line-height: 20px;">Thank you for showing your interest in Equinix Webinar 2020.<!-- on 23rd July 11 AM IST hello. --></td>
                  </tr>   
                   <tr>
                    <td width="20">&nbsp;</td>
